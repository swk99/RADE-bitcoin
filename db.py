...
CREATE TABLE IF NOT EXISTS experiments (
    ...
    ablation_type TEXT NOT NULL DEFAULT 'full',
...
ADD COLUMN IF NOT EXISTS ablation_type TEXT NOT NULL DEFAULT 'full';
...
class EpisodeDB:
    ...
    def create_experiment(
        ...
        sql = """
            INSERT INTO experiments (policy, ablation_type, lambda_cost, seed, notes)
            VALUES (%s, %s, %s, %s, %s)
            RETURNING run_id::text
        """
        with self.conn.cursor() as cur:
            cur.execute(sql, (policy, ablation_type, lambda_cost, seed, notes))
